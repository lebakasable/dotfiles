...
evaluate-commands %sh{
  ...
  echo "
      ...
      set-face global MenuInfo           ${crust},${mauve}
      set-face global Information        ${crust},${mauve}
      set-face global Error              ${crust},${red}
      set-face global StatusLine         ${text},default
      ...
      set-face global Prompt             ${mauve},default
      set-face global MatchingChar       ${maroon},default
      set-face global Whitespace         ${overlay1},default
